...
# publish the demo: copy the wit-dom-shim directory in your site
...
No glue between JS and Rust/Wasm (more info about [the glue issue](https://hacks.mozilla.org/2019/08/webassembly-interface-types/)): no marshalling/unmarshaling of the DOM elements between both languages : the shim manages the delegation of the DOM manipulations from the Rust code to the browser via a JS implementation of the [WIT resource/handle](https://component-model.bytecodealliance.org/design/wit.html?highlight=handle#resources) concept (the shim).
